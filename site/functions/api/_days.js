...
/* Куда пункт переехал. Одна ручка на оба способа: перетаскивание внутри дня и
   «перенести в день →» — это одно и то же движение, отличается только тем,
   откуда взялось число `at`. */
