/* Чек поездки: единственное место, где складываются деньги.
   ...
   * **Итог в долларах — сумма показанных долларов, а не пересчёт общей иены.**
     Иначе столбик на экране не сходится с числом под ним. Так было на итоге
     22 августа (число с тех пор сменилось, пример оставлен как пример): из
     ¥297 912 выходило $1 875, а из четырёх городских чисел — $1 876. Это уже
     было решено для жилья (см. README), и её записи считаются так же.
