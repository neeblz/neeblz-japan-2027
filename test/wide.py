...
Порог — 1650 точек при ширине 1440. Прежний был 1800 — «2 экрана это ок», её
слово 2026-08-23. После того как подробности проживания уехали под стрелку,
страница стала 1604, и порог переставлен по этому измерению, а не по прежнему
запасу: сетка, сквозь которую свободно пролезает двести точек нового, ничего
не ловит.
